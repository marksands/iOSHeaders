...
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *dbChangedQueue; // @synthesize dbChangedQueue=_dbChangedQueue;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *unsavedChangesQueue; // @synthesize unsavedChangesQueue=_unsavedChangesQueue;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *registeredQueue; // @synthesize registeredQueue=_registeredQueue;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *calendarQueue; // @synthesize calendarQueue=_calendarQueue;
...
@property(retain, nonatomic) NSMutableDictionary *publicRegisteredObjects; // @synthesize publicRegisteredObjects=_publicRegisteredObjects;
...
- (void)setAutomaticLocationGeocodingAllowed:(_Bool)arg1;
