...
- (void)_temp_setFlag_tracking:(_Bool)arg1;
- (void)_temp_setFlag_systemGesturesRecognitionPossible:(_Bool)arg1;
- (_Bool)_temp_getFlag_systemGesturesRecognitionPossible;
