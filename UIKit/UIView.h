...
- (struct CGRect)frame;
- (_Bool)inFullyDisappearedState;
- (_Bool)inFullyAppearedState;
- (_Bool)temporaryAppearanceStateClean;
- (void)performCompletionAppearanceCallbacksForSubview:(id)arg1;
- (void)performCompletionAppearanceCallbacksForSubHierarchy;
- (void)performCompletionCallbacksPending:(_Bool)arg1;
...
- (void)sendViewDidDisappearAnimated:(_Bool)arg1;
- (void)sendViewWillDisappearAnimated:(_Bool)arg1;
- (void)sendViewDidAppearAnimated:(_Bool)arg1;
- (void)sendViewWillAppearAnimated:(_Bool)arg1;
- (void)pushVisualStateRecursively;
- (void)applyUpdatesRecursively:(_Bool)arg1 subHierarchyAppearanceState:(long long)arg2 immediateAnimated:(_Bool)arg3 newChange:(_Bool)arg4;
- (void)sendAppearanceCallbacksForDisappearingViewWithSubHierarchyAppearanceState:(long long)arg1 animated:(_Bool)arg2;
- (void)sendAppearanceCallbacksForAppearingViewWithSubHierarchyAppearanceState:(long long)arg1 animated:(_Bool)arg2 appearingType:(long long)arg3;
- (void)applyUpdatesRecursively;
- (_Bool)viewGeneratorNewChange;
...
- (id)retain;
- (_Bool)_la_isVisible;
@property(nonatomic, setter=_setHasMirrorTransform:) _Bool _hasMirrorTransform;
