...
@class HKGraphSeries, HKGraphView, HKValueRange, NSArray;

@protocol HKGraphViewDelegate <NSObject>
- (void)graphView:(HKGraphView *)arg1 didUpdateSeries:(HKGraphSeries *)arg2;
...
- (void)graphView:(HKGraphView *)arg1 didUpdateVisibleValueRange:(HKValueRange *)arg2;
