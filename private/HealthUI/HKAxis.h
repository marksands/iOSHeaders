...
@class HKAxisStyle, HKCoordinateTransform, HKValueRange, NSMutableArray, NSString;
...
+ (struct HKAxisMinMaxDefinition)expandByPoints:(double)arg1 modelRange:(struct HKAxisMinMaxDefinition)arg2 pointRange:(struct HKAxisMinMaxDefinition)arg3;
...
- (id)_gridLinesForModelRange:(id)arg1 axisRect:(struct CGRect)arg2 zoomScale:(double)arg3 contentOffset:(struct CGPoint)arg4 style:(id)arg5 majorGridLines:(_Bool)arg6;
...
- (void)_drawTextForModelRange:(id)arg1 inRect:(struct CGRect)arg2 zoomScale:(double)arg3 contentOffset:(struct CGPoint)arg4 renderView:(id)arg5 style:(id)arg6;
...
- (void)drawGridlinesForModelRange:(id)arg1 chartRect:(struct CGRect)arg2 zoomScale:(double)arg3 contentOffset:(struct CGPoint)arg4 renderView:(id)arg5;
- (void)drawLabelsWithModelRange:(id)arg1 chartRect:(struct CGRect)arg2 zoomScale:(double)arg3 contentOffset:(struct CGPoint)arg4 touchPoints:(id)arg5 renderView:(id)arg6;
