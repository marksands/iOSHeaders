...
+ (CDStruct_f18e9e0a *)getStatusBarOverrideData;
+ (const CDStruct_c6256135 *)getStatusBarData;
+ (id)_cachedTimeStringFromData:(CDStruct_c6256135 *)arg1;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_f18e9e0a *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_c6256135 *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_c6256135 *)arg1 actions:(int)arg2 animated:(_Bool)arg3;
- (void)dealloc;
