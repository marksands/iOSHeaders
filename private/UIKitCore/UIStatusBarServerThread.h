...
@interface UIStatusBarServerThread : NSThread
{
    ...
    CDStruct_c6256135 _statusBarData;
    CDStruct_c6256135 _composedStatusBarData;
    CDStruct_f18e9e0a _overrides;
...
- (void)_postStatusBarOverrideData:(CDStruct_f18e9e0a *)arg1;
...
- (int)_styleOverrides;
- (void)_postStatusBarData:(CDStruct_c6256135 *)arg1 actions:(int)arg2 animated:(_Bool)arg3;
- (void)_broadcastStatusBarDataWithActions:(int)arg1 animated:(_Bool)arg2;
- (CDStruct_f18e9e0a *)_statusBarOverrideData;
- (CDStruct_c6256135 *)_statusBarData;
