...
- (void).cxx_destruct;
- (void)contextForPageURL:(id)arg1 content:(id)arg2 contentType:(long long)arg3 metadata:(id)arg4 isPrivate:(_Bool)arg5 withCompletionHandler:(CDUnknownBlockType)arg6;
