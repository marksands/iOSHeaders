...
@interface CAMCaptureCapabilities : NSObject
{
    ...
    _Bool _backDuoSupported;
    _Bool _frontDuoSupported;
...
@property(readonly, nonatomic, getter=isFrontDuoSupported) _Bool frontDuoSupported; // @synthesize frontDuoSupported=_frontDuoSupported;
@property(readonly, nonatomic, getter=isBackDuoSupported) _Bool backDuoSupported; // @synthesize backDuoSupported=_backDuoSupported;
...
- (_Bool)shouldUseDuoForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3;
- (_Bool)isDuoSupportedForMode:(long long)arg1 devicePosition:(long long)arg2 videoConfiguration:(long long)arg3;
- (_Bool)isDuoSupportedForDevicePosition:(long long)arg1;
