...
- (void)_updateCaptureAggregateDictionariesForRequest:(id)arg1 response:(id)arg2 isFinalResponse:(_Bool)arg3;
- (struct __CFString *)_aggregateDictionaryKeyForPressType:(long long)arg1;
