...
- (id)interestingDate;
- (id)dedupeIdentifier;
- (void)populateTextFeatureValuesForProperty:(id)arg1 updatingBundleFeatureValues:(id)arg2 withEvaluator:(id)arg3 withContext:(struct prs_feature_population_ctx_t *)arg4 featureScoreInfo:(struct PRSL2FeatureScoreInfo *)arg5 fuzzyEvaluator:(id)arg6 propertyCanFuzzyMatch:(_Bool)arg7 keyboardLanguage:(id)arg8;
- (void)populateFeaturesWithEvaluator:(id)arg1 updatingBundleFeatures:(float *)arg2 withContext:(struct prs_feature_population_ctx_t *)arg3 fuzzyEvaluator:(id)arg4 keyboardLanguage:(id)arg5;
