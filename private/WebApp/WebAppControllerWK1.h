...
@class NSArray, NSMutableArray, NSMutableSet, NSString, UIWebView, UIWindow, WBUSheetController, WebUIAuthenticationManager, WebUIDownloadManager;

@interface WebAppControllerWK1 : WebAppController <WebPolicyDelegate, UIApplicationDelegate, UIWebViewDelegate, UIWebViewPrivateDelegate>
{
    UIWebView *webView;
