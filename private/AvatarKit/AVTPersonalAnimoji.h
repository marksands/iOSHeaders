...
@class AVTColorPreset, AVTComponent, AVTComponentInstance, AVTPersonalAnimojiSkeleton, AVTPreset, AVTRig, NSDictionary, NSString, SCNMaterial, SCNNode;

@interface AVTPersonalAnimoji : AVTAvatar
{
    ...
    AVTPersonalAnimojiSkeleton *_skeleton;
...
+ (id)personalAnimojiWithData:(id)arg1 error:(id *)arg2;
+ (id)personalAnimojiWithContentsOfURL:(id)arg1 error:(id *)arg2;
+ (id)personalAnimoji;
+ (id)neutralPersonalAnimoji;
+ (id)neutralPersonalAnimojiDataRepresentation;
- (void).cxx_destruct;
...
- (void)componentInstanceDidChange:(id)arg1 componentType:(long long)arg2;
- (void)update;
- (void)_updateAO;
