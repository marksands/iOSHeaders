...
+ (void)fetchRecentDonationsWithLimit:(unsigned long long)arg1 applicationBundleIdentifier:(id)arg2 filteringForIsEligibleForPrediction:(_Bool)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
