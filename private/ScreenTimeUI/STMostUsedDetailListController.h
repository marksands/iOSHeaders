...
@interface STMostUsedDetailListController : STListViewController
{
...
- (void).cxx_destruct;
- (void)viewDidLoad;
- (id)initWithUsageItem:(id)arg1 usageDetailsViewModel:(id)arg2 timeAllowancesCoordinator:(id)arg3 canAskForMoreTime:(_Bool)arg4;
