...
- (_Bool)addPointyRoofForBuilding:(CDStruct_de1a80f1 *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (_Bool)canConstructPointyRoofForPolygon:(CDStruct_6ac9d495 *)arg1 building:(CDStruct_de1a80f1 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
...
- (void)addBuilding:(CDStruct_de1a80f1 *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(id)arg5 prepareExtrusion:(_Bool)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
