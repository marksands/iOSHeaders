...
@interface VKOverlayContainerModel : VKMapTileModel <VKRouteMatchedAnnotationPresentationObserver, VKRouteContextObserver, VKMapLayer, VKStyleManagerObserver>
{
    ...
    _Bool _isShowingOuterHaloOnLabels;
...
@property(readonly, nonatomic) _Bool isShowingOuterHaloOnLabels; // @synthesize isShowingOuterHaloOnLabels=_isShowingOuterHaloOnLabels;
