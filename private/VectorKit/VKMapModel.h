...
- (void)overlayContainer:(id)arg1 showingOuterHaloOnLabelsDidChange:(_Bool)arg2;
- (_Bool)overlayContainerIsInTransitMode:(id)arg1;
- (_Bool)overlayContainerIsInNavigationMode:(id)arg1;
...
- (id)createSourceForLayer:(unsigned long long)arg1 useAdditionalManifest:(_Bool)arg2;
...
- (id)createSourceForLayer:(unsigned long long)arg1 tileSet:(id)arg2 useAdditionalManifest:(_Bool)arg3;
- (_Bool)canPitch;
