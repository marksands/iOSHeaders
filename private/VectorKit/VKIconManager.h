...
- (_Bool)_getIconStyleDescriptorForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 iconStyleDescriptor:(struct VKIconStyleDescriptor *)arg4 transitMode:(_Bool)arg5 interactive:(_Bool)arg6;
