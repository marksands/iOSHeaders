...
+ (_Bool)isAnyDestinationAvailableForItem:(id)arg1 usingCache:(id)arg2;
+ (id)sharedManager;
...
@property(readonly, nonatomic) NSMutableSet *destinations; // @synthesize destinations=_destinations;
