...
- (_Bool)allCurrentItemsAreKnown:(id)arg1;
- (void)beginQueryWithItems:(id)arg1;
- (void)cancelQueries;
- (_Bool)_checkAvailabilityForItem:(id)arg1 withCache:(id)arg2;
- (_Bool)audioAvailableForItem:(id)arg1;
- (_Bool)videoAvailableForItem:(id)arg1;
- (void)dealloc;
- (id)init;
