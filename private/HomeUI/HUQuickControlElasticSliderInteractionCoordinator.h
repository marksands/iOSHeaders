...
@class HUDisplayLinkApplier, HUElasticApplier, HUQuickControlSliderGestureTransformer, HUQuickControlViewProfile<HUQuickControlIncrementalConvertibleProfile>, NSString, UILongPressGestureRecognizer;
