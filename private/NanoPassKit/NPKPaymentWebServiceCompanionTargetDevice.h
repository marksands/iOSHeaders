...
- (void)setDefaultExpressFelicaTransitPassIdentifier:(id)arg1 applicationIdentifier:(id)arg2 requestAuthorization:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
