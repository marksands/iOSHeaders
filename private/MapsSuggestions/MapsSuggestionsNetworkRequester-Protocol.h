...
- (_Bool)ETAsFromHereWaypoint:(GEOComposedWaypoint *)arg1 destinationWaypoints:(struct NSArray *)arg2 transportType:(int)arg3 automobileOptions:(GEOAutomobileOptions *)arg4 completion:(void (^)(NSArray *, NSArray *, NSError *))arg5;
