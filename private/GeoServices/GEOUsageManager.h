...
- (void)_captureNetworUsageLogMessageForRequester:(id)arg1 service:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(long long)arg5 traits:(id)arg6 remoteAddressAndPort:(id)arg7 fromLogFrameworkAdaptor:(_Bool)arg8;
...
- (void)captureDirectionsEventForDirectionsFeedbacks:(id)arg1 finalLocation:(id)arg2 arrivedAtDestination:(_Bool)arg3 navigationAudioFeedback:(struct GEONavigationAudioFeedback)arg4 durationOfTrip:(double)arg5 traits:(id)arg6;
...
- (void)captureNetworkEventForRequester:(id)arg1 networkService:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(long long)arg5 traits:(id)arg6 fromLogFrameworkAdaptor:(_Bool)arg7;
...
- (void)captureStateTransitionEventWithStates:(id)arg1 generateOnlyIfStateChanged:(_Bool)arg2 traits:(id)arg3;
...
- (void)captureMapLaunchEventWithLaunchUrl:(id)arg1 sourceAppId:(id)arg2 isLaunchedFromTTL:(_Bool)arg3 ttlEventTime:(id)arg4 traits:(id)arg5;
