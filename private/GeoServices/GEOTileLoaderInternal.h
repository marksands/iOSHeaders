...
- (void)_decodeTileForKey:(struct _GEOTileKey)arg1 preliminary:(_Bool)arg2 quickly:(_Bool)arg3 tileDecoder:(id)arg4 data:(id)arg5 disburseTile:(CDUnknownBlockType)arg6;
