...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_928c0167 *_laneConnections;
    unsigned long long _laneConnectionsCount;
    CDStruct_928c0167 *_pointsOnRoad;
    ...
    CDStruct_aaaa018a *_lineCharacteristicPoints;
    unsigned long long _lineCharacteristicPointCount;
    CDStruct_aaaa018a *_polygonCharacteristicPoints;
    unsigned long long _polygonCharacteristicPointCount;
    CDStruct_aaaa018a *_coastlineCharacteristicPoints;
    unsigned long long _coastlineCharacteristicPointCount;
    CDStruct_928c0167 *_lineStrokeSpecifications;
    unsigned long long _lineStrokeSpecificationCount;
    CDStruct_928c0167 *_polygonStrokeSpecifications;
    ...
    CDStruct_928c0167 *_transitPointsOnRoad;
...
@property(readonly, nonatomic) CDStruct_928c0167 *transitPointsOnRoad; // @synthesize transitPointsOnRoad=_transitPointsOnRoad;
...
@property(readonly, nonatomic) CDStruct_928c0167 *polygonStrokeSpecifications; // @synthesize polygonStrokeSpecifications=_polygonStrokeSpecifications;
...
@property(readonly, nonatomic) CDStruct_928c0167 *lineStrokeSpecifications; // @synthesize lineStrokeSpecifications=_lineStrokeSpecifications;
...
@property(readonly, nonatomic) CDStruct_aaaa018a *coastlineCharacteristicPoints; // @synthesize coastlineCharacteristicPoints=_coastlineCharacteristicPoints;
...
@property(readonly, nonatomic) CDStruct_aaaa018a *polygonCharacteristicPoints; // @synthesize polygonCharacteristicPoints=_polygonCharacteristicPoints;
...
@property(readonly, nonatomic) CDStruct_aaaa018a *lineCharacteristicPoints; // @synthesize lineCharacteristicPoints=_lineCharacteristicPoints;
...
@property(readonly, nonatomic) CDStruct_928c0167 *laneConnections; // @synthesize laneConnections=_laneConnections;
...
@property(readonly, nonatomic) CDStruct_928c0167 *pointsOnRoad; // @synthesize pointsOnRoad=_pointsOnRoad;
