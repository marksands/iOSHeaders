...
- (id)initForNearestTransitStationWithLine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2 includeETA:(_Bool)arg3 traits:(id)arg4;
...
- (id)initWithSearchCategory:(id)arg1 venueIdentifier:(id)arg2 maxResults:(unsigned int)arg3 includeETA:(_Bool)arg4 traits:(id)arg5;
...
- (id)initWithReverseGeocodeCoordinate:(CDStruct_c3b9c2ee)arg1 floorOrdinal:(int)arg2 includeEntryPoints:(_Bool)arg3 includeETA:(_Bool)arg4 preserveOriginalLocation:(_Bool)arg5 traits:(id)arg6;
...
- (id)initWithIdentifiers:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4;
