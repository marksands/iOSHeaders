...
- (void)autoSetupNetBaseName:(id)arg1 weights:(id)arg2 scaleConfig:(int)arg3 setupMode:(int)arg4 computePath:(int)arg5 autoAspectRatio:(float)arg6 forceReset:(_Bool)arg7 useLowPriorityMode:(_Bool)arg8 gpuPriority:(unsigned long long)arg9;
- (void)wipeLayersMemory;
- (void)reset;
- (void)autoResizeForAspectRatio:(float)arg1 useLowPriorityMode:(_Bool)arg2 gpuPriority:(unsigned long long)arg3;
