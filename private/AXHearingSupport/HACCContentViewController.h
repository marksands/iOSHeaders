...
@class MTMaterialView, NSString, UIPreviewInteraction, UITapGestureRecognizer, UIView, UIView<HACCContentModule>, UIViewController<CCUIContentModuleContentViewController>;
