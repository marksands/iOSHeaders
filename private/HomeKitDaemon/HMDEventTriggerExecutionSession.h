...
@class HMDEventTriggerUserConfirmationSession, HMDPredicateUtilities, HMDTriggerConfirmationTimer, NSArray, NSMapTable, NSMutableArray, NSPredicate, NSString;
...
- (void)_handleActionSetExecutionResponse:(id)arg1 error:(id)arg2 completion:(CDUnknownBlockType)arg3;
