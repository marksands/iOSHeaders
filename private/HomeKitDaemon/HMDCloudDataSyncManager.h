...
@property(retain, nonatomic) CKRecord *homeDataRecordVersion3; // @synthesize homeDataRecordVersion3=_homeDataRecordVersion3;
...
@property(retain, nonatomic) NSString *lastHomeDataChangeTagVersion3; // @synthesize lastHomeDataChangeTagVersion3=_lastHomeDataChangeTagVersion3;
...
@property(retain, nonatomic) CKRecordID *homeDataBlobRecordIDVersion3; // @synthesize homeDataBlobRecordIDVersion3=_homeDataBlobRecordIDVersion3;
