...
- (void)__handleAddAirPlayAccessoryModel:(id)arg1 message:(id)arg2;
...
- (void)saveWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3 objectChange:(id)arg4;
