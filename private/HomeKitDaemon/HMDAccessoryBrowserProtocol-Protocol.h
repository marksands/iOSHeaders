...
- (void)pairAccessoryWithDescription:(HMSetupAccessoryDescription *)arg1 homeName:(NSString *)arg2 neeedsUserConfirmation:(_Bool)arg3 progressHandler:(void (^)(NSUUID *, NSString *, NSString *, HMAccessoryCategory *, long long, unsigned long long))arg4 completionHandler:(void (^)(HAPAccessoryServer *, NSUUID *, long long, NSError *))arg5;
- (void)pairAccessory:(HMDUnpairedHAPAccessory *)arg1 homeName:(NSString *)arg2 setupCode:(NSString *)arg3 setupCodeProvider:(void (^)(HMDUnpairedHAPAccessory *, NSString *, void (^)(NSString *, NSError *)))arg4 completionHandler:(void (^)(HAPAccessoryServer *, NSUUID *, long long, NSError *))arg5;
