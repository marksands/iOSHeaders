...
- (id)_askForTimeResourceForAction:(long long)arg1;
...
- (void)_changeBottomButtonToEnterScreenTimePasscode;
- (void)_changeBottomButtonToIgnoreLimit;
- (void)_changeBottomButtonToAskForMore;
