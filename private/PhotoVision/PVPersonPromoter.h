...
@class NSMutableDictionary, PVPersonClusterManager, PVPersonDeduperProfile, PVPersonPromoterProfile;
...
+ (void)setProcessed:(_Bool)arg1 atURL:(id)arg2;
+ (_Bool)hasProcessedAtURL:(id)arg1;
...
- (_Bool)_promoteVerifiedPersons:(id)arg1 updateBlock:(CDUnknownBlockType)arg2;
...
- (id)interestingPersonsFromPersons:(id)arg1;
