...
@property(nonatomic) __weak id <NCNotificationActionTextInputDelegate> textInputDelegate; // @synthesize textInputDelegate=_textInputDelegate;
...
@property(nonatomic) __weak id <NCInteractiveNotificationHostDelegate> delegate; // @synthesize delegate=_delegate;
