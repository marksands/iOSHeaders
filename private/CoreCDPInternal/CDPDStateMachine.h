...
- (void)_recoverSecureBackupWithRemotePeers:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_handleBackupRecoveryWithPeersForRemoteApproval:(_Bool)arg1 circleStatus:(int)arg2 completion:(CDUnknownBlockType)arg3;
