...
- (_Bool)_completePersonBuildingWithPersonsToUpdate:(id)arg1 facesToRemoveByPerson:(id)arg2 facesToAddByPerson:(id)arg3 updateFaceGroup:(id)arg4 mergeCandidatePairsToAdd:(id)arg5 mergeCandidatePairsToRemove:(id)arg6 faceByCSN:(id)arg7 personCache:(id)arg8 keyFaceUpdateBlock:(CDUnknownBlockType)arg9 canceler:(id)arg10 context:(id)arg11 error:(id *)arg12;
...
- (_Bool)persistChangesToAlgorithmicFaceGroups:(id)arg1 facesToUpdate:(id)arg2 canceler:(id)arg3 clusterSequenceNumbersOfFacesNotPersisted:(id)arg4 toBeReclusteredFaceLocalIdentifiers:(id)arg5 persistenceHandlerBlock:(CDUnknownBlockType)arg6 error:(id *)arg7;
...
- (_Bool)getFace:(id *)arg1 associatedWithFaceCrop:(id)arg2 error:(id *)arg3;
