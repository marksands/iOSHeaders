...
- (_Bool)_mergePersons:(id)arg1 error:(id *)arg2;
- (id)_countOfFacesByPerson:(id)arg1 using:(id)arg2 ignore:(id)arg3;
- (void)_consolidatePersonsToMerge:(id)arg1;
- (_Bool)_completePersonBuildingWithPersonsToUpdate:(id)arg1 facesToRemoveByPerson:(id)arg2 facesToAddByPerson:(id)arg3 updateFaceGroup:(id)arg4 canceler:(id)arg5 error:(id *)arg6;
