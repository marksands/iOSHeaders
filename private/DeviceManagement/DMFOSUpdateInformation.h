...
- (id)initWithHumanReadableLanguage:(id)arg1 humanReadableUpdateName:(id)arg2 productSystemName:(id)arg3 productVersion:(id)arg4 productBuildVersion:(id)arg5 downloadSize:(id)arg6 installationSize:(id)arg7 isCritical:(_Bool)arg8 isRestartRequired:(_Bool)arg9;
