...
- (_Bool)_mergeBookmark:(id)arg1 withOriginalBookmark:(id)arg2;
...
- (_Bool)_bookmark:(id)arg1 hasPriorityOverBookmarkForDeduplication:(id)arg2 davHomePath:(id)arg3;
- (_Bool)_recalculateCachedChildrenCountAndOrderIndices;
- (_Bool)_deleteAndRebuildAncestorTableRecords;
- (_Bool)_deduplicateBookmarksWithRootFolder:(int)arg1 depth:(unsigned long long)arg2 trackChanges:(_Bool)arg3 davHomeURL:(id)arg4;
- (_Bool)_deduplicateBookmarksForSyncingAndTrackChanges:(_Bool)arg1;
