...
- (void)createMockTransactionsAndAdjustBalanceForAuthorizedPeerPaymentQuote:(id)arg1;
...
- (id)_quoteItemDictionaryWithType:(unsigned long long)arg1 amount:(id)arg2 dpanID:(id)arg3 featureDescriptor:(id)arg4;
