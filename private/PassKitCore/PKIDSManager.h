...
@class IDSService, NSArray, NSArray<PKIDSManagerDelegate>, NSHashTable, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, PKProximityAdvertiser;
