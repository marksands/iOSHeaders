...
- (void)fetchReportsDuringInterval:(NSDateInterval *)arg1 partitionInterval:(double)arg2 focalOnly:(_Bool)arg3 forceImmediateSync:(_Bool)arg4 replyHandler:(void (^)(NSString *, NSDictionary *, NSArray *, NSError *))arg5;
@end
