...
- (void)_cropImage:(id)arg1 cacheResult:(_Bool)arg2 isDegraded:(_Bool)arg3 forRequest:(id)arg4 didCallFastBlock:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;
...
- (int)requestFaceTileImageFromFaceCollection:(id)arg1 withTargetSize:(struct CGSize)arg2 cropFactor:(unsigned long long)arg3 round:(_Bool)arg4 cacheResult:(_Bool)arg5 boundFaceRect:(_Bool)arg6 completionBlock:(CDUnknownBlockType)arg7;
- (int)_requestFaceTileImageFromRequest:(id)arg1 withTargetSize:(struct CGSize)arg2 cropFactor:(unsigned long long)arg3 round:(_Bool)arg4 cacheResult:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6 fastDisplayBlock:(CDUnknownBlockType)arg7;
