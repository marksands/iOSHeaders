...
+ (id)standardizedAttributedStringFromAttributedString:(id)arg1 fixAttachments:(_Bool)arg2 translateTTFont:(_Bool)arg3;
+ (id)bulletTextAttributesWithTextFont:(struct UIFont *)arg1 paragraphStyle:(id)arg2 letterpress:(_Bool)arg3;
