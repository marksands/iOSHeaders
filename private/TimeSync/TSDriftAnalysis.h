...
- (void)dealloc;
- (_Bool)exportDriftToPath:(id)arg1;
- (_Bool)exportDriftToDirectoryURL:(id)arg1 withFilename:(id)arg2;
- (_Bool)exportDriftToDirectoryURL:(id)arg1;
