...
- (void)__provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 session:(id)arg3 recursively:(_Bool)arg4 readingOptions:(unsigned long long)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_waitForDownloadOfDirectory:(id)arg1 key:(id)arg2 requireCurrent:(_Bool)arg3 readingOptions:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_waitForDownloadOfDocument:(id)arg1 key:(id)arg2 requireCurrent:(_Bool)arg3 readingOptions:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
