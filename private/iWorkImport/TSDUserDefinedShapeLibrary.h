...
- (void)p_addUserDefinedShapeWithPathSource:(id)arg1 atIndex:(unsigned long long)arg2 pathSourceDefaults:(id)arg3 withChangedIndexSet:(id)arg4;
...
- (_Bool)updateShapeAtIndex:(unsigned long long)arg1 withName:(id)arg2;
- (_Bool)removeUserDefinedShapeAtIndex:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (_Bool)removeUserDefinedShapeAtIndex:(unsigned long long)arg1;
- (void)insertUserDefinedShapeWithPathSource:(id)arg1 atIndex:(unsigned long long)arg2 documentRoot:(id)arg3;
- (void)addUserDefinedShapesWithPathSources:(id)arg1 documentRoot:(id)arg2;
