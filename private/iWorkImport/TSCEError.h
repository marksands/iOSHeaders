...
+ (void)raiseErrorForInvalidReference:(CDStruct_fc93c73e)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3 invalidMergeReference:(_Bool)arg4 disqualifiedFromEndCell:(_Bool)arg5;
