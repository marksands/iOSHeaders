...
- (id)initWithRoutineManager:(id)arg1 initWithPastEventTitlesAndParticipants:(id)arg2 earliestStartTime:(double)arg3 shouldConsiderAlarms:(_Bool)arg4 withOptions:(int)arg5;
