...
+ (id)databaseTable;
+ (_Bool)enumerateDeletedSamplesWithType:(id)arg1 profile:(id)arg2 sourceIdentifier:(id)arg3 limit:(unsigned long long)arg4 anchor:(long long)arg5 error:(id *)arg6 handler:(CDUnknownBlockType)arg7;
