...
- (_Bool)deleteSamplesWithUUIDs:(NSArray *)arg1 recursiveDeleteAuthorizationBlock:(_Bool (^)(NSSet *, NSSet *))arg2 error:(id *)arg3;
- (_Bool)deleteSamplesWithTypes:(NSSet *)arg1 sourceID:(NSNumber *)arg2 recursiveDeleteAuthorizationBlock:(_Bool (^)(NSSet *, NSSet *))arg3 error:(id *)arg4;
- (_Bool)deleteSamplesWithSourceIdentifier:(NSNumber *)arg1 error:(id *)arg2;
- (_Bool)deleteDataObjectsOfClass:(Class)arg1 predicate:(HDSQLitePredicate *)arg2 limit:(unsigned long long)arg3 deletedSampleCount:(unsigned long long *)arg4 notifyObservers:(_Bool)arg5 generateDeletedObjects:(_Bool)arg6 recursiveDeleteAuthorizationBlock:(_Bool (^)(NSSet *, NSSet *))arg7 error:(id *)arg8;
- (_Bool)deleteDataObjects:(NSArray *)arg1 restrictedSourceEntity:(HDSourceEntity *)arg2 failIfNotFound:(_Bool)arg3 recursiveDeleteAuthorizationBlock:(_Bool (^)(NSSet *, NSSet *))arg4 error:(id *)arg5;
