...
- (_Bool)_insertDataObjects:(id)arg1 intoDatabase:(id)arg2 withProvenance:(id)arg3 creationDate:(double)arg4 skipInsertionFilter:(_Bool)arg5 updateSourceOrder:(_Bool)arg6 error:(id *)arg7;
