...
+ (_Bool)_getAuthorizationRecordsBySourceWithDictionary:(id)arg1 predicate:(id)arg2 profile:(id)arg3 error:(id *)arg4;
...
+ (_Bool)getAuthorizationRecordsByTypeWithDictionary:(id)arg1 sourceEntity:(id)arg2 types:(id)arg3 profile:(id)arg4 error:(id *)arg5;
+ (_Bool)getAuthorizationStatusesWithDictionary:(id)arg1 sourceEntity:(id)arg2 types:(id)arg3 profile:(id)arg4 error:(id *)arg5;
