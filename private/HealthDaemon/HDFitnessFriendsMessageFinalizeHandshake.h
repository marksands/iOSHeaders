...
@property(retain, nonatomic) HDFitnessFriendsMessageActivityDataPreview *activityDataPreview; // @synthesize activityDataPreview=_activityDataPreview;
@property(retain, nonatomic) HDFitnessFriendsMessageShareLocations *inviterShareLocations; // @synthesize inviterShareLocations=_inviterShareLocations;
