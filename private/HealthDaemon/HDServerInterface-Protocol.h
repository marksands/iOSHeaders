...
@class HKCharacteristicType, HKDocumentType, HKLocationSeriesSample, HKObjectType, HKQuantityType, HKUnit, NSArray, NSDate, NSDictionary, NSError, NSNumber, NSSet, NSString, NSUUID, _HKDeepBreathingSessionConfiguration, _HKFilter, _HKQueryServerDataObject;
...
- (void)remote_currentlyPairedWatchIdentifiersWithCompletion:(void (^)(NSSet *, NSError *))arg1;
...
- (void)remote_discardLocationSeries:(HKLocationSeriesSample *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)remote_finishLocationSeries:(HKLocationSeriesSample *)arg1 withMetadata:(NSDictionary *)arg2 completion:(void (^)(HKLocationSeriesSample *, NSError *))arg3;
- (void)remote_saveLocationSeriesData:(NSArray *)arg1 withSeriesSample:(HKLocationSeriesSample *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
- (void)_remote_attachDeepBreathingSessionServerWithClient:(id)arg1 sessionConfiguration:(_HKDeepBreathingSessionConfiguration *)arg2 handler:(void (^)(id, _Bool, NSError *))arg3;
...
- (void)remote_proxyForFitnessFriendsServerWithCompletion:(void (^)(HDFitnessFriendsServer *, NSError *))arg1;
@end
