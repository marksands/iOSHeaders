...
#import "MRExternalClientConnectionDelegate.h"

@class MRExternalClientConnection, MRExternalDeviceTransport, MRSupportedProtocolMessages, NSInputStream, NSObject<OS_dispatch_queue>, NSOutputStream, NSString;
