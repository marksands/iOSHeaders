...
- (id)selectedPhoneNumberRegistrationSubscriptionWithError:(id *)arg1 persistUpdateIfNeeded:(_Bool)arg2;
...
- (_Bool)_PNRSubscription:(id)arg1 doesMatchSubscriptionNumber:(long long)arg2;
