...
+ (_Bool)_deleteAllTopicsWithPredicate:(id)arg1 error:(id *)arg2;
...
+ (_Bool)_deleteAllNamedEntitiesWithPredicate:(id)arg1 error:(id *)arg2;
+ (_Bool)_deleteAllExtractionsWithPredicate:(id)arg1 fromStreams:(id)arg2 deletedCount:(unsigned long long *)arg3 error:(id *)arg4;
