...
@interface FCDefinition : NSObject
{
    ...
    id <FCDefinitionContainer> _privateAccessContainer;
}

@property(retain, nonatomic) id <FCDefinitionContainer> privateAccessContainer; // @synthesize privateAccessContainer=_privateAccessContainer;
