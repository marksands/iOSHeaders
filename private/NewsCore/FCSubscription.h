...
+ (id)subscriptionWithSubscriptionID:(id)arg1 tagID:(id)arg2 type:(unsigned long long)arg3 origin:(unsigned long long)arg4 groupID:(id)arg5 dateAdded:(id)arg6 notificationsEnabled:(_Bool)arg7;
...
- (id)initWithSubscriptionID:(id)arg1 tagID:(id)arg2 groupID:(id)arg3 dateAdded:(id)arg4 subscriptionType:(unsigned long long)arg5 origin:(unsigned long long)arg6 notificationsEnabled:(_Bool)arg7;
