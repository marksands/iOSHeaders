...
@interface FCAppConfiguration : NSObject
{
    ...
    _Bool _privateDataEncryptionRequiresAllDevicesRunningTigris;
    ...
    NSString *_personalizationPublisherFavorabilityResourceId;
...
@property(nonatomic) _Bool privateDataEncryptionRequiresAllDevicesRunningTigris; // @synthesize privateDataEncryptionRequiresAllDevicesRunningTigris=_privateDataEncryptionRequiresAllDevicesRunningTigris;
...
@property(retain, nonatomic) NSString *personalizationPublisherFavorabilityResourceId; // @synthesize personalizationPublisherFavorabilityResourceId=_personalizationPublisherFavorabilityResourceId;
