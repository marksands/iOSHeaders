...
- (_Bool)validateWord:(id)arg1 inLexiconForLanguage:(id)arg2 requiredMetaFlags:(unsigned int)arg3 prohibitedMetaFlags:(unsigned int)arg4;
...
- (void)_addLanguageModelCompletionsForPrefix:(id)arg1 languageModel:(void *)arg2 language:(id)arg3 connection:(struct _PR_DB_IO *)arg4 sender:(id)arg5 encoding:(unsigned int)arg6 capitalized:(_Bool)arg7 candidates:(id)arg8;
...
- (unsigned int)_tokenIDForString:(id)arg1 languageModel:(void *)arg2 language:(id)arg3 createIfAbsent:(_Bool)arg4 terminatorTokenID:(unsigned int)arg5;
