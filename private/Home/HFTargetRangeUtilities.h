...
+ (id)targetValueWithTargetMode:(unsigned long long)arg1 currentMode:(unsigned long long)arg2 rawTargetValue:(id)arg3 minimumThresholdValue:(id)arg4 maximumThresholdValue:(id)arg5;
