...
@class HFAccessorySettingsValueManager, HFHomeKitDispatcher, HMAccessory, HMAccessoryProfile<HFAccessorySettings>, HMAccessorySettings, HMHome, NSMutableDictionary, NSSet, NSString;
