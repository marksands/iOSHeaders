...
- (void)handleUploadBatchesFromEvent:(id)arg1 insertedPhotoCount:(unsigned long long *)arg2 insertedVideoCount:(unsigned long long *)arg3 totalSizeOfUnpushedOriginals:(unsigned long long *)arg4 shouldTriggerPrefetch:(_Bool *)arg5;
