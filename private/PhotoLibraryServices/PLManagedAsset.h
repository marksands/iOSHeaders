...
- (void)_appendBusinessName:(id)arg1 toAsset:(id)arg2;
...
- (void)getSearchIndexContents:(id)arg1 graphData:(id)arg2 dateFormatter:(id)arg3 keywords:(id)arg4 synonymsDictionaries:(id)arg5;
...
- (_Bool)setupPlaceholderAssetWithRequiredPropertiesFromSourceAsset:(id)arg1 assetUUID:(id)arg2 placeholderAssetMomentShareUUID:(id)arg3 bakeInAdjustmentsFromSourceAssetIfNecessary:(_Bool)arg4 library:(id)arg5;
...
- (unsigned long long)_masterResourceTypeForAdjustedAssetResourceType:(unsigned long long)arg1 sourceAsset:(id)arg2;
