...
+ (_Bool)knownFileExtensionForType:(id)arg1;
...
- (void)getFileURL:(id *)arg1 originalFilename:(id *)arg2 uti:(id *)arg3 fileSize:(long long *)arg4 forSidecarMatchingUTI:(id)arg5 requireExactMatch:(_Bool)arg6;
...
- (id)cameraMake;
- (id)_videoMetadata;
- (id)imagePropertiesAllowReadFromFile:(_Bool)arg1;
...
- (id)pl_photoLibrary;
- (void)didSave;
- (_Bool)_hasBecomeNonVisibleToMemories:(id)arg1;
- (void)willSave;
...
@property(nonatomic) _Bool hasAdjustedVideoComplement;
...
- (_Bool)attemptPromoteFromUnknownKind;
