...
- (id)_addUniqueCollectionNodeWithSortedMomentNodes:(id)arg1 meaningLabel:(id)arg2 meaningIsReliable:(_Bool)arg3 weight:(float)arg4 score:(double)arg5;
...
- (id)_baseIdentifierForMomentIdentifier:(id)arg1;
- (id)collectionUUIDForSortedMomentNodes:(id)arg1;
- (id)collectionUUIDForSortedMoments:(id)arg1;
- (id)assetCollectionForCollectionWithMomentNodes:(id)arg1;
- (double)_confidenceForPotentialMePersonNode:(id)arg1 inPhotoLibrary:(id)arg2;
...
- (id)allHobbies;
- (_Bool)_fetchPointsOfInterestForRegions:(id)arg1;
- (id)_momentNodesByRegionsToFetchWithMomentNodes:(id)arg1;
...
- (void)disambiguatePointsOfInterestWithInsertedMomentNodes:(id)arg1;
