...
@class NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_os_log>, NSRecursiveLock, NSString, NSURL, PGGraph, PGMemoryController, PHPhotoLibrary, PIPipeline;
