...
@interface SXFontMatchingAttributes : NSObject <SXFontAttributes>
{
...
+ (id)attributesWithWithFamilyName:(id)arg1 weight:(long long)arg2 width:(long long)arg3 style:(long long)arg4;
