...
#import "SXVideoItemViewControllerFactory.h"

@class NSString;

@interface SXVideoItemViewControllerFactory : NSObject <SXVideoItemViewControllerFactory>
{
...
- (void).cxx_destruct;
- (id)videoItemViewControllerForVideo:(id)arg1;
