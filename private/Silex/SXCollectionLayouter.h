...
- (id)collectionLayoutCollectionDisplay:(id)arg1 width:(double)arg2 numberOfComponents:(unsigned long long)arg3 componentLayout:(id)arg4 columnLayout:(id)arg5;
