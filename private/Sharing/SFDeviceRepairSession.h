...
@class NSMutableArray, NSObject<OS_dispatch_queue>, SFDevice, SFDeviceOperationHomeKitSetup, SFDeviceOperationWiFiSetup, SFSession, TROperationQueue, TRSession, UIViewController;
