...
@property(nonatomic) _Bool senderIsMe; // @synthesize senderIsMe=_senderIsMe;
...
@property(nonatomic, getter=shouldHideProgress) _Bool hideProgress; // @synthesize hideProgress=_hideProgress;
...
@property(readonly, nonatomic, getter=isOnlyPhotosOrVideos) _Bool onlyPhotosOrVideos; // @synthesize onlyPhotosOrVideos=_onlyPhotosOrVideos;
