...
@class MSPJournal, MSPMapsPaths, NSMutableArray, NSOperationQueue, NSString;
...
- (id)_scheduleTaskIfAny:(id)arg1 isMerge:(_Bool)arg2 forUserObservableChange:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
