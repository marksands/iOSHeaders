...
+ (id)_navigation_replacementForFormatToken:(id)arg1 timeStampTimeZone:(id)arg2 abbreviatedUnits:(_Bool)arg3 detail:(long long)arg4 spoken:(_Bool)arg5;
...
+ (id)_navigation_stringForServerFormattedString:(id)arg1 timeZone:(id)arg2 abbreviatedUnits:(_Bool)arg3 detail:(long long)arg4 spoken:(_Bool)arg5 overrideVariables:(id)arg6;
