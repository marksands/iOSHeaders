...
@class GEOAlightNotificationFeedback, GEOComposedWaypoint, GEOETARoute, GEONameInfo, GEONavigationGuidanceState, GEOStep, MNActiveRouteInfo, MNGuidanceLaneInfo, MNGuidanceSignInfo, MNLocation, MNNavigationSession, MNTrafficIncidentAlert, NSArray, NSDate, NSString, NSUUID;
