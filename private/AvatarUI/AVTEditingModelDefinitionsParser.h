...
- (_Bool)validateForCategoryWithEnumValue:(id)arg1 presetPickers:(id)arg2 colorPicker:(id)arg3 colorPaletteCategory:(id)arg4;
- (id)coreModelColorPaletteForColorPickerDictionary:(id)arg1 settingDestination:(long long)arg2;
