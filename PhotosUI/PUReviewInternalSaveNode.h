...
@class NSArray, NSData, NSString, NSURL, PUEditableMediaProviderImageDataNode, PUEditableMediaProviderVideoURLNode, PUImageDataRenderNode, PUPhotoEditIrisModel;
@protocol PUVideoURLNode, PXRunNodeDelegate;
...
@interface PUReviewInternalSaveNode : PXRunNode <PUImageInfoNode, PUVideoURLNode, PUAdjustmentURLNode, PUReviewImageURLNode, PUReviewVideoURLNode, PUImageDataRenderNode>
{
    ...
    id <PUVideoURLNode> _videoRenderNode;
    NSURL *_directory;
...
@property(readonly, nonatomic) id <PUVideoURLNode> videoRenderNode; // @synthesize videoRenderNode=_videoRenderNode;
