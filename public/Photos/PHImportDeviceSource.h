...
@interface PHImportDeviceSource : PHImportSource <ICCameraDeviceDelegate>
{
    ...
    _Bool _waitingForAssetFileRequest;
...
- (_Bool)cameraDevice:(id)arg1 shouldGetThumbnailOfItem:(id)arg2;
...
- (void)_sendNextAssetDataRequestForType:(unsigned char)arg1 requestDidComplete:(_Bool)arg2;
