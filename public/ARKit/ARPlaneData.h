...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: @92@0:8r^{SurfaceExtent<float>={Matrix<float, 3, 3>=[9f]}{vector<acv::geometry::BoundingBox2<float>, std::__1::allocator<acv::geometry::BoundingBox2<float> > >=^{BoundingBox2<float>}^{BoundingBox2<float>}{__compressed_pair<acv::geometry::BoundingBox2<float> *, std::__1::allocator<acv::geometry::BoundingBox2<float> > >=^{BoundingBox2<float>}}}{SE3GroupStorage<float, cva::Matrix<float, 4, 4> >=[16f]}}16{?=[4]}24i88, name: _gridExtentFromSurfaceExtent:planeToAnchorTransform:alignmentRotation:
-     // Error parsing type: {?=}92@0:8r^{SurfaceExtent<float>={Matrix<float, 3, 3>=[9f]}{vector<acv::geometry::BoundingBox2<float>, std::__1::allocator<acv::geometry::BoundingBox2<float> > >=^{BoundingBox2<float>}^{BoundingBox2<float>}{__compressed_pair<acv::geometry::BoundingBox2<float> *, std::__1::allocator<acv::geometry::BoundingBox2<float> > >=^{BoundingBox2<float>}}}{SE3GroupStorage<float, cva::Matrix<float, 4, 4> >=[16f]}}16{?=[4]}24i88, name: _boundsFromSurfaceExtent:planeToAnchorTransform:alignmentRotation:
