...
- (id)ticketForNearestTransitStation:(id)arg1 coordinate:(struct CLLocationCoordinate2D)arg2 includeETA:(_Bool)arg3 traits:(id)arg4;
- (id)ticketForTransitLines:(id)arg1 traits:(id)arg2;
- (id)ticketForChildPlace:(id)arg1 includeETA:(_Bool)arg2 traits:(id)arg3;
...
- (id)ticketForReverseGeocodeCoordinate:(struct CLLocationCoordinate2D)arg1 includeETA:(_Bool)arg2 traits:(id)arg3;
- (id)_ticketForReverseGeocodeCoordinate:(struct CLLocationCoordinate2D)arg1 floorOrdinal:(int)arg2 includeEntryPoints:(_Bool)arg3 includeETA:(_Bool)arg4 preserveOriginalLocation:(_Bool)arg5 traits:(id)arg6;
- (id)_ticketForReverseGeocodeCoordinate:(struct CLLocationCoordinate2D)arg1 includeEntryPoints:(_Bool)arg2 includeETA:(_Bool)arg3 preserveOriginalLocation:(_Bool)arg4 traits:(id)arg5;
