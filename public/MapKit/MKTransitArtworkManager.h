...
- (id)transitArtworkImageWithDataSource:(id)arg1 size:(long long)arg2 featureType:(unsigned long long)arg3 forView:(id)arg4 withWidthPaddingMultiple:(double)arg5 fullBleedColor:(id *)arg6;
