...
@interface _INPBIntentSlotValue : PBCodable <NSCopying>
{
    ...
    CDStruct_95bda58d _PayloadItemTypes;
...
@property(retain, nonatomic) NSMutableArray *PayloadNotebookLocations;
...
@property(retain, nonatomic) NSMutableArray *PayloadDataTimes;
...
@property(readonly, nonatomic) int *PayloadItemTypes;
@property(readonly, nonatomic) unsigned long long PayloadItemTypesCount;
