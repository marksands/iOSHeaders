...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: v48@0:8^{SecurityOrigin={atomic<unsigned int>=AI}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{optional<unsigned short>=B(constexpr_storage_t<unsigned short>=CS)}BBBBiBBB}16^{WebFrameProxy=^^?@^{WebPageProxy}{FrameLoadState=i{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{String={RefPtr<WTF::StringImpl>=^{StringImpl}}}BB{RefPtr<WebKit::WebCertificateInfo>=^{WebCertificateInfo}}{RefPtr<WebKit::WebFrameListenerProxy>=^{WebFrameListenerProxy}}Q{ContentFilterUnblockHandler={String={RefPtr<WTF::StringImpl>=^{StringImpl}}}{URL={String={RefPtr<WTF::StringImpl>=^{StringImpl}}}b1b1b1IIIIIIIII}{function<void (std::__1::function<void (bool)>)>={type=[32C]}^{__base<void (std::__1::function<void (bool)>)>}}{RetainPtr<WebFilterEvaluator>=^v}}}24^{GeolocationPermissionRequestProxy=^^?@^{GeolocationPermissionRequestManagerProxy}Q}32@40, name: decidePolicyForGeolocationRequestFromOrigin:frame:request:view:
