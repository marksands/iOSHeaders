...
- (void)setHashTableBufferRange:(struct MPSBufferRange *)arg1;
- (struct MPSBufferRange *)hashTableBufferRange;
- (void)setDisplacementTableBufferRange:(struct MPSBufferRange *)arg1;
- (struct MPSBufferRange *)displacementTableBufferRange;
- (void)setNodeBufferRange:(struct MPSBufferRange *)arg1;
