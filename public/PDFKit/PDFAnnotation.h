...
- (_Bool)setVarious:(id)arg1 forAnnotationKey:(id)arg2;
- (_Bool)setInteger:(id)arg1 forAnnotationKey:(id)arg2;
- (_Bool)setDictionary:(id)arg1 forAnnotationKey:(id)arg2;
- (_Bool)setArray:(id)arg1 forAnnotationKey:(id)arg2;
- (_Bool)setString:(id)arg1 forAnnotationKey:(id)arg2;
