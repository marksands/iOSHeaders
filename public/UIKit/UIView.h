...
@property(nonatomic, setter=_setContentManagementState:) unsigned long long _contentManagementState;
...
@property(nonatomic) _Bool allowsSimultaneousDragsToBegin;
@property(nonatomic) __weak id <_UIViewDraggingDestinationDelegate> draggingDestinationDelegate;
@property(nonatomic) __weak id <_UIViewDraggingSourceDelegate> draggingSourceDelegate;
