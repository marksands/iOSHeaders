...
@class NSMutableArray, PUEditableMediaProvider, PUPhotoEditResourceLoadRequest, PUResourceDownloadRequest;
...
@property(retain, nonatomic, setter=_setDownloadRequest:) PUResourceDownloadRequest *_downloadRequest; // @synthesize _downloadRequest=__downloadRequest;
