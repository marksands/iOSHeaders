...
- (id)issueContentKeyRequestWithIdentifier:(id)arg1 initializationData:(id)arg2 providesPersistableKey:(_Bool)arg3 context:(id)arg4 asset:(id)arg5;
...
- (id)initWithStorageDirectoryAtURL:(id)arg1 internal:(_Bool)arg2;
